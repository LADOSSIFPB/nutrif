...
public class DiaRefeicaoDAO extends GenericDao<Integer, DiaRefeicao> {
	...
	public List<DiaRefeicao> getDiaRefeicaoRealizadaByAlunoNome(String nome) {
		...
		logger.info("Buscar Dia de Refei��o por Nome: " + nome);
	...
	public List<DiaRefeicao> getDiaRefeicaoRealizadaByAlunoMatricula(
		...
		logger.info("Buscar Dia de Refei��o por Matr�cula: " + matricula);
	...
	/**
	 * Quantificar a quantidade de refei��es servidas para um determinado edital.
	 * 
	 * @param idEdital
	 * @return
	 */
	...
	/**
	 * Quantificar as refei��o que ser�o servidas num determinado dia da semana
	...
	public List<DiaRefeicao> getDiaRefeicaoByPeriodoEdital(DiaRefeicao diaRefeicao){
		...
		try {
			...
			// Verificar editais vigentes no per�odo do edital que ir� conceder o benef�cio.			
	...
	public List<DiaRefeicao> getDiaRefeicaoByDia(Integer dia) {
		...
		logger.info("Buscar Dia de Refei��o por dia. ");
