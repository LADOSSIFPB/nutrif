...
public class AlunoController {
	...
	public Response insert(Aluno aluno) {
		...
		if (validacao == Validate.VALIDATE_OK) {
			...
			try {
				// Nome do aluno somente com a primeira letra em mai�sculo.
				...
				if (curso != null
					...
					//TODO: Mensagem de erro para Curso, Campus ou Roles n�o encontrados.
				}				
	...
	/**
	 * Recuperar Aluno pela matr�cula.
	 * 
	 * @param matricula
	 * @return
	 */
	...
	/**
	 * Inserir acesso do Aluno ao sistema via dispositivo m�vel.
	...
	public Response insertAcesso(AlunoAcesso alunoAcesso) {
		...
		if (validacao == Validate.VALIDATE_OK) {
			...
			try {
				...
				// Recuperar Aluno atrav�s da matr�cula.
				Aluno aluno = AlunoDAO.getInstance().getByMatricula(matricula);
				...
				if (aluno != null 
					...
					// Verificar se o usu�rio j� tem acesso solicitado.					
					if (!aluno.isAcesso()) {
					...
					// Gerar chave de confirma��o: KeyConfirmation.
	...
	public Response sendEmail(Aluno aluno) {
		...
		try {
			...
			EmailUtil emailUtil = new EmailUtil();
			emailUtil.send(aluno.getEmail(), "Ativa��o da conta.", 
				"Chave de confirma��o: ");
	...
	/**
	 * Login para Aluno. Retorna a chave de autentica��o caso o usu�rio esteja
	 * com a matr�cula e senha corretas.
	 * 
	 * @param pessoaAcesso
	 * @return
	 */
			...
			try {
				...
				if (aluno != null) {			
					...
					if (pessoa != null) {
						...
						// Matr�cula do aluno n�o encontrada.
						Error error =  ErrorFactory.getErrorFromIndex(
					...
					// Autentica��o n�o permitida: senha n�o confere.
					Error error =  ErrorFactory.getErrorFromIndex(
							ErrorFactory.ALUNO_NAO_ENCONTRADO);
